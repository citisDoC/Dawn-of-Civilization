...
iCivTamils :	Techs([iGuilds], column=6, exceptions=[iArchitecture]),
...
iCivByzantium :	Techs([iArchitecture, iPolitics, iEthics, iTheology, iScholarship], column=5),
iCivJapan :	Techs([iCommune, iEducation, iCropRotation, iCompass], column=7, exceptions = [iTheology]),
iCivVikings : 	Techs([iNobility, iArtisanry, iPolitics, iArchitecture, iGuilds], column=5, exceptions = [iPhilosophy, iPriesthood, iMedicine]),
iCivArabia :	Techs([iAlchemy, iTheology], column=6, exceptions=[iPolitics]),
iCivTibet :	Techs([iNobility, iScholarship, iEthics], column=5),
iCivIndonesia :	Techs([iEthics, iNobility, iArchitecture], column=5, exceptions=[]),
iCivMoors :	Techs([iMachinery, iAlchemy, iTheology], column=6, exceptions=[iPolitics]),
iCivSpain : 	Techs([iFeudalism, iAlchemy, iGuilds, iFortification], column=6),
iCivFrance :	Techs([], column=6, exceptions=[iScholarship, iArchitecture]),
...
iCivHolyRome :	Techs([iFeudalism], column=6, exceptions=[iArtisanry, iScholarship]),
...
iCivItaly : 	Techs([iGuilds], column=6),
...
iCivChina :	Techs([iMachinery], column=6, exceptions=[iNobility, iPolitics, iEthics, iScholarship, iMedicine]),
iCivIndia :	Techs([iNobility, iSteel, iPolitics, iFeudalism], column=5, exceptions = [iEngineering, iAesthetics, iMedicine]),
iCivPersia :	Techs([iFortification], column=6, exceptions = [iPolitics, iArtisanry, iEthics, iMedicine]),
iCivRome :	Techs([iArchitecture, iPolitics, iEthics, iScholarship], column=5),
iCivKorea :	Techs(column=6, exceptions=[iNobility, iEthics, iArchitecture, iPolitics, iScholarship, iMedicine]),
},
{
